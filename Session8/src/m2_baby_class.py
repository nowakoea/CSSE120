...
class Baby(object):
    def __init__(self, name):
        self.name = name
        self.number_of_times_fed = 0
        self.number_of_hours_passed = 0
        print('Hello baby {}'.format(self.name))

    def feed_baby(self):
        self.number_of_times_fed = self.number_of_times_fed + 1
        self.number_of_hours_passed = 0
    ...
    def hour_passes(self):
        ...
        if self.number_of_hours_passed == 1:
            ...
            print('Baby {} is awake.  Time for food.'.format(
                self.name))
        elif self.number_of_hours_passed >= 3:
