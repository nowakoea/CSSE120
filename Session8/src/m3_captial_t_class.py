...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        h_rect = rg.Rectangle((intersection_center.x - width / 2,
                               intersection_center.y - height / 2),
                              (intersection_center.x + width / 2,
                               intersection_center.y + height / 2))
        v_rect = rg.Rectangle((intersection_center.x - height / 2,
                               intersection_center.y - width / 2),
                              (intersection_center.x + height / 2,
                               intersection_center.y + width / 2))
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        return CapitalT(self.intersection_center, self.width, self.height,
