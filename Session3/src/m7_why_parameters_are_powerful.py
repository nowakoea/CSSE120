...
def run_test_even_better_draw_circles():
    # Test 1:
    even_better_draw_circles(5, 6, 200, 200)

    # Test 2:
    even_better_draw_circles(7, 5, 300, 300)

    # Test 3:
    even_better_draw_circles(3, 7, 200, 300)


def even_better_draw_circles(rad, n, centx, centy):
    window = rg.RoseWindow(400, 400)
