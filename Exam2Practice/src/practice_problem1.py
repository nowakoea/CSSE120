...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        """
        # --------------------------------------------------------------
        # DONE:    See the testing code (below) for more examples.
        # --------------------------------------------------------------
        # --------------------------------------------------------------
    ...
    def append_string(self, additional_contents):
        ...
        # space = self.volume
        # number_of_characters_to_append = len(self.contents)-self.volume
        #
    ...
    def double(self):
        ...
        seq1 = ''
        for k in range(counter - 1, len(self.contents)):
            seq1 = seq1 + str(self.contents[k]) + ''
    ...
    def reset(self):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        self.contents.__init__()
        self.volume.__init__()
    ...
    def steal(self, other_box):
        ...
        #    ** TWO **   LINES OF CODE.
        ################################################################
        other_box.append_string(self.contents)
    ...
    def combined_box(self, other_box):
        ...
        other_box.append_string(self.contents)
        return Box(self.contents, volume)
