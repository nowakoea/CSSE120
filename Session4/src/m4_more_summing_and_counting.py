...
def run_test_sum_from():
    ...
    answer_from_my_code = sum_from(6, 10)
    ...
    answer_from_my_code = sum_from(100, 10001)
    ...
    answer_from_my_code = sum_from(1, 4)
    ...
    answer_from_my_code = sum_from(53, 5000)
...
def run_test_factorial():
    ...
    print('Test 4 expected (from by-hand):', answer_from_by_hand)
    print('       actual (from my code):  ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(3, 6, 0.7)
    ...
    # Test 6:
    expected = 0
    answer = count_cosines_from(2, 6, 0.29)
