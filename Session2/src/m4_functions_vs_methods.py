...
def main():
    ...
    try_functions(100, 200, 0, 0)
    try_functions(-50, 50, 100, 100)
...
def try_functions(x1, y1, x2, y2):
    ...
    """
    jumper1 = rg.SimpleTurtle()
    jumper1.pen = rg.Pen('blue', 20)
    jumper1.speed = 1

    jumper1.pen_up()
    jumper1.go_to(rg.Point(x1, y1))

    jumper1.pen_down()
    jumper1.go_to(rg.Point(x2, y2))
