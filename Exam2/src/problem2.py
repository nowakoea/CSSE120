...
def run_test_problem2a():
    ...
    actual = problem2a(strings)
    print('  This test case calls:')
    print('    problem2a(', strings, ')')
...
def run_test_problem2b():
    ...
    strings = ['two', 'prime', 'xxx', 'abcabc', 'yyy', 'xxxx', 'abcabcX', 'ab']
    expected = 6
    actual = problem2b(strings)
    print('  This test case calls:')
    print('    problem2b(', strings, ')')
    print("  Expected:", expected)
    print("  Actual:  ", actual)
    print_result_of_test(expected, actual)
...
def run_test_problem2c():
    ...
    actual = problem2c(strings)
    print('  This test case calls:')
    print('    problem2c(', strings, ')')
    print("  Expected:", expected)
    print("  Actual:  ", actual)
    print_result_of_test(expected, actual)
...
def run_test_problem2d():
    ...
    print()
    print('--------------------------------------------------')
    print('Testing the   problem2d   function:')
    print('--------------------------------------------------')
    ...
    strings = ['1234', '1234567890', '123', '12', '1', '123', '123']
    expected = '123'
    actual = problem2d(strings)
    print('  This test case calls:')
    print('    problem2d(', strings, ')')
    print("  Expected:", expected)
    print("  Actual:  ", actual)
    print_result_of_test(expected, actual)
